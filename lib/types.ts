...
export interface Realization { id: string; planId: string; title: string; value: string; description: string; date: string; time: string; uploadedBy: string | null; targets?: RealizationTarget[]; participants?: RealizationParticipant[]; }
